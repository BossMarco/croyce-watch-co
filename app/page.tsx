  ...
  return <main>
    ...
    <section className="hero" id="top">
      <div className="hero-copy">
        ...
        <div className="hero-actions hero-enter delay-4"><a className="button button-gold" href="https://www.instagram.com/c_royce_co" target="_blank" rel="noreferrer">Explore recent finds <ArrowIcon /></a><a className="text-link" href="#visit">Visit the shop</a></div>
      ...
      <div className="hero-visual" aria-label="Vintage mechanical wristwatch"><Image src="/croyce-watch-hero.webp" alt="Vintage mechanical wristwatch on walnut and leather" fill priority sizes="(max-width: 900px) 100vw, 52vw"/><WatchAtmosphere/><div className="orbit-ring" aria-hidden="true"/><div className="floating-note"><small>Specialists in</small><strong>Vintage</strong></div></div>
    </section>
