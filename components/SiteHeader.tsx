...
export function SiteHeader() {
  ...
  return <header className="nav-shell">
    <a className="wordmark" href="#top" aria-label="C. Royce Watch Co. home" onClick={close}><span className="monogram">CR</span><span>C. ROYCE <em>WATCH CO.</em></span></a>
    <nav className="desktop-nav" aria-label="Main navigation"><a href="#story">Our Story</a><a href="#services">Services</a><a href="#visit">Visit</a></nav>
    ...
    <div className={`mobile-menu${open ? " is-open" : ""}`} id="mobile-menu" aria-hidden={!open}>
      <nav aria-label="Mobile navigation"><a href="#story" onClick={close}><span>01</span>Our Story</a><a href="#services" onClick={close}><span>02</span>Services</a><a href="#visit" onClick={close}><span>03</span>Visit</a></nav>
